...
RSpec.describe StandardId::Providers::Google do
  ...
  describe ".get_user_info" do
    ...
    context "without code, id_token, or access_token" do
      it "raises an error" do
        ...
        end.to raise_error(StandardId::InvalidRequestError, "Either code, id_token, or access_token must be provided")
      end
    end
  end
  ...
  describe ".exchange_code_for_user_info" do
    ...
    it "raises error when code is blank" do
      ...
      end.to raise_error(StandardId::InvalidRequestError, "Missing authorization code")
    end
    ...
    it "raises error when token exchange fails" do
      ...
      end.to raise_error(StandardId::InvalidRequestError, "Failed to exchange Google authorization code")
    end
    ...
    it "raises error when access_token is missing from response" do
      ...
      expect do
        described_class.exchange_code_for_user_info(code: code, redirect_uri: redirect_uri)
      end.to raise_error(StandardId::InvalidRequestError, "Google response missing access token")
    end
  end
  ...
  describe ".verify_id_token" do
    ...
    it "raises error when id_token is blank" do
      ...
      end.to raise_error(StandardId::InvalidRequestError, "Missing id_token")
    end
    ...
    it "raises error when id_token verification fails" do
      ...
      end.to raise_error(StandardId::InvalidRequestError, "Invalid or expired id_token")
    end
    ...
    it "raises error when audience mismatches" do
      ...
      expect do
        described_class.verify_id_token(id_token: id_token)
      end.to raise_error(StandardId::InvalidRequestError, /ID token audience mismatch/)
    end
    ...
    it "raises error when issuer is invalid" do
      ...
      expect do
        described_class.verify_id_token(id_token: id_token)
      end.to raise_error(StandardId::InvalidRequestError, /ID token issuer invalid/)
    end
  ...
  describe ".fetch_user_info" do
    ...
    it "raises error when access_token is blank" do
      ...
      end.to raise_error(StandardId::InvalidRequestError, "Missing access token")
    end
    ...
    it "raises error when user info fetch fails" do
      ...
      end.to raise_error(StandardId::InvalidRequestError, "Failed to fetch Google user info")
    end
  end
  ...
  describe ".verify_token" do
    ...
    it "raises error when token verification fails" do
      ...
      end.to raise_error(StandardId::InvalidRequestError, "Invalid or expired access token")
    end
    ...
    it "raises error when audience mismatches" do
      ...
      expect do
        described_class.send(:verify_token, access_token)
      end.to raise_error(StandardId::InvalidRequestError, /Access token audience mismatch/)
    end
  end
end
